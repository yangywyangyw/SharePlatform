...
{
	if (self.delegate && [[self delegate] respondsToSelector:@selector(authenticationNeededForRequest:)]) {
...
{
	if (self.delegate && [[self delegate] respondsToSelector:@selector(proxyAuthenticationNeededForRequest:)]) {
